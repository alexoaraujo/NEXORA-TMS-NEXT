...
-- Force RLS so table owners do not bypass these policies accidentally.
...
-- Cross-table tenant consistency is enforced at the application/domain layer in P0.2;
-- PostgreSQL RLS protects the row boundary. Regulatory reference data is intentionally
-- global and therefore not tenant-scoped.
COMMIT;
